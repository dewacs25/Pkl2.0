...
@section('content')
    <section id="hero" class="hero d-flex align-items-center">
        <div class="container-fluid "
            style="height: 70vh;
    background: url('{{ asset('storage/'.$isi->gambar) }}');
                ...
                <h1 class="animate__animated animate__fadeInUp text-center" style="color: #ffe27a; font-size:57px; ">
                    ...
                    <div style="display: flex; justify-content:center;">
                        <a type="button" class="animate__animated animate__fadeInUp text-white text-center "><i
                                class="fa-solid fa-house text-white"></i>&nbsp;Home&nbsp;>&nbsp;Layanan&nbsp;
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar">
                            ...
                            <div class="sidebar-item recent-posts">
                                ...
                                <div class="post-item clearfix">
                                    <img src="{{ asset('logoumkn/buton.JPG') }}" alt="">
                                    <h4><a class="text-dark" href="">Et dolores corrupti quae illo quod dolor</a>
                                    </h4>
